...
<template>
	...
	<main class="bg-cyan-50/30 font-space-grotesk">
		<div class="flex w-full p-20 gap-10 divide-x divide-gray-300">
			...
			<div class="basis-3/4 px-4">
				...
				<div
					...
					<CourseCard v-for="(course) in courses" :key="course.id" :id="course.id" :imageUrl="course.imageUrl"
						:title="course.name" :location="course.location" :price="course.price" :slots="course.inStock"
